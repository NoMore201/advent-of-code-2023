...
TEST(AdventOfCode, Day2Part1) {
    EXPECT_EQ(2486, AoC::day2_solution_part1(exercise_input));
}

TEST(AdventOfCode, Day2Part2) {
    EXPECT_EQ(87984, AoC::day2_solution_part2(exercise_input));
}