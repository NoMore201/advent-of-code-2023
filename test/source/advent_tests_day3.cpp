...
TEST(AdventOfCode, Day3Part1) {
    EXPECT_EQ(538046, AoC::day3_solution_part1(exercise_input));
}

TEST(AdventOfCode, Day3Part2) {
    EXPECT_EQ(81709807, AoC::day3_solution_part2(exercise_input));
}